...
public class PessoaController implements PessoaRepository {
	...
	public void cadastrarPessoa(Pessoa pessoa) {
		...
		System.out.println(pessoa.getNome() + ", Você foi cadastrade com sucesso !!!");
	...
	public boolean pesoDoacao(double peso) {
		...
		if (peso < 50) {
			System.out.println("Você tem menos que 50 quilos. Doar pode ser prejudicial a sua saúde.");
			return false;
		}
